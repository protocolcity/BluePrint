...
For how the desk's own vocabulary maps to these engines (Projects = stores, Agents = hired seats + live shifts, Delivery = GitHub evidence, WorkLane/WorkForce stay separate packages), see [README.md § How the desk works](README.md#how-the-desk-works-in-one-breath) or the full [docs/specs/SUITE_VOCABULARY.md](docs/specs/SUITE_VOCABULARY.md).
