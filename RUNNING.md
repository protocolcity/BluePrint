...
For You membership (Decide / Read / Watch / Note) is
[`docs/specs/ALWAYS_WORK_PROCESS.md`](docs/specs/ALWAYS_WORK_PROCESS.md) §5
plus [`docs/specs/FOR_YOU_INBOX_REPORTS.md`](docs/specs/FOR_YOU_INBOX_REPORTS.md).
The drop tool is `scripts/report_to_for_you.py`. Optional **github-desk**
is GitHub issue intake — not that inbox bridge.
